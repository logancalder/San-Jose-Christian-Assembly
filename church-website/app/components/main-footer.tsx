...
export default function MainFooter({ language }: MainFooterProps) {
  return (
    <footer className="bg-[#272727] text-[#fbf8f3] py-16 border-t border-[#313437]">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div>
              <h3 className="font-bold text-lg mb-4 text-[#fbf8f3]">
              ...
              <Link 
                ...
                target="_blank"
                className="inline-block mt-3 text-sm text-[#636363] hover:text-[#fbf8f3] transition-colors"
              >
            ...
            <div>
              ...
              <p className="mt-4 text-sm text-[#636363]">
                {language === "en" 
          ...
          <div className="mt-12 pt-8 border-t border-[#313437] text-center">
